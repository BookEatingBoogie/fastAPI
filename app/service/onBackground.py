...
async def getContentNow(choice: str, charName: str, responseId: str, file_name: str, page: int, charLook: str, server_url: str):
    try:
        if page == 4:
        ...
        raise HTTPException(status_code=500, detail=f"동화 : 중간부 생성 실패: {e}")

async def getEndingNow(choice: str, charName: str, responseId: str, file_name: str, charLook: str, server_url: str):
    try:
        ...
        raise HTTPException(status_code=500, detail=f"동화 : 엔딩 생성 실패: {e}")
